...
def seed_playlist_songs_users_likes():
    ...
    song3 = Song(
        name="4N", artist_name="Hiroyuki Sawano", artist_id=4, mp3_file="4N.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song4 = Song(
        name="8SIX", artist_name="Hiroyuki Sawano", artist_id=4, mp3_file="8SIX.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song5 = Song(
        name="pianoVIIIVI-i", artist_name="Hiroyuki Sawano", artist_id=4, mp3_file="pianoVIIIVI-i.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song6 = Song(
        name="pianoVIIIVI-iii", artist_name="Hiroyuki Sawano", artist_id=4, mp3_file="pianoVIIIVI-iii.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song7 = Song(
        name="Lilas", artist_name="Hiroyuki Sawano", artist_id=4, mp3_file="lilas.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song8 = Song(
        name="JaguarN0-10", artist_name="Hiroyuki Sawano", artist_id=4, mp3_file="jaguarN0-10.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song9 = Song(
        name="Talk to you", artist_name="Kohta Yamamoto", artist_id=5, mp3_file="Talktoyou.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song10 = Song(
        name="Underneath the Sky", artist_name="Kohta Yamamoto", artist_id=5, mp3_file="Underneath the Sky.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song11 = Song(
        name="Hear My Voice", artist_name="Kohta Yamamoto", artist_id=5, mp3_file="Hearmyvoice.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
    song12 = Song(
        name="Never Stopping at All", artist_name="Sweet Dove", artist_id=5, mp3_file="Neverstoppingatall.mp3", genre="Instrumental", created_at=date.today(), updated_at=date.today())
